...
class Qwen2Attention(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        layer_dir = f"/home/chengzhang/RetrievalAttention2/data/Qwen2.5-7B-128k-FWE-8/layer_{self.layer_idx:02}"
        print(f"Saving data for layer {self.layer_idx}")
        import os
        os.makedirs(layer_dir, exist_ok=True)
        torch.save(query_states, f"{layer_dir}/q.pt")
        torch.save(key_states, f"{layer_dir}/k.pt")
        torch.save(value_states, f"{layer_dir}/v.pt")

        cos, sin = position_embeddings
        query_states, key_states = apply_rotary_pos_emb(query_states, key_states, cos, sin)

        torch.save(query_states, f"{layer_dir}/q_rope.pt")
        torch.save(key_states, f"{layer_dir}/k_rope.pt")
        ...
        torch.save(attn_output, f"{layer_dir}/o.pt")
